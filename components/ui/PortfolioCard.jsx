...
const PortfolioCard = ({ url, title, category, des }) => {
    return (
            ...
            <CardHeader>
                ...
                <div className="rounded-lg !inline-flex relative overflow-hidden">
                    ...
                    <div className="flexCenter gap-x-4 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 scale-0 group-hover:scale-100 group-hover:opacity-100 transition-all duration-300">
                        ...
                        <Link href={'/'} className="flexCenter gap-x-2 rounded-md px-1 ring-1 ring-primary text-primary"><BiSolidLike /><p>112</p></Link>
                        <Link href={'/'} className="flexCenter gap-x-2 rounded-md px-1 ring-1 ring-primary text-primary"><FaEye /><p>222</p></Link>
                    </div>
                </div>
            </CardHeader>
            {/* info */}
